...
class SynaptiqClient:
    ...
    def store_memory(self, agent_id: str, memory_type: str, content: str, subtype: Optional[str] = None, confidence: float = 1.0, importance: float = 0.5) -> Dict[str, Any]:
        """
    ...
    def retrieve(self, agent_id: str, query: str, limit: int = 5, memory_type: Optional[str] = None) -> Dict[str, Any]:
        """
